...
The official specification for Agent Skills is now located at <https://agentskills.io/specification>.

This document serves as the local reference for the architectural standards used in this repository's skill definitions.
