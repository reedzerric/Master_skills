...
description: 'Standards for writing documents that agents read: skills, AGENTS.md, CLAUDE.md. Use when creating or editing a skill file or an agent instruction document. For this repository''s frontmatter schema specifically, read SKILL_STANDARD.md.'
version: 1.0.0
category: utilities
triggers: [write a skill, edit agents.md, edit claude.md, writing for agents, agent instructions]
dependencies: []
inputs: [a draft skill or agent doc]
outputs: [a rewritten agent-facing document]
tags: [meta, writing, documentation]
links: ['[[skill-router]]']
