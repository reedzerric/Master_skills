...
description: Turns a decision the agent cannot fully answer into a questionnaire for someone else to fill in. User-invoked. Use when the blocker is missing human knowledge rather than missing analysis.
version: 1.0.0
category: utilities
triggers: [questionnaire, ask someone else, i cannot answer this, need input from the team]
dependencies: []
inputs: [an unresolved decision]
outputs: [a questionnaire document]
tags: [decisions, collaboration]
links: ['[[skill-router]]']
